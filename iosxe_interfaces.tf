  ...
  interfaces_ethernets = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.ethernets, []) : {
        ...
        authentication_order_dot1x                      = try(int.network_access_control.authentication_order_dot1x, null)
        authentication_order_dot1x_mab                  = try(int.network_access_control.authentication_order_dot1x_mab, null)
        authentication_order_dot1x_webauth              = try(int.network_access_control.authentication_order_dot1x_webauth, null)
        authentication_order_mab                        = try(int.network_access_control.authentication_order_mab, null)
        authentication_order_mab_dot1x                  = try(int.network_access_control.authentication_order_mab_dot1x, null)
        authentication_order_mab_webauth                = try(int.network_access_control.authentication_order_mab_webauth, null)
        authentication_order_webauth                    = try(int.network_access_control.authentication_order_webauth, null)
        authentication_priority_dot1x                   = try(int.network_access_control.authentication_priority_dot1x, null)
        authentication_priority_dot1x_mab               = try(int.network_access_control.authentication_priority_dot1x_mab, null)
        authentication_priority_dot1x_webauth           = try(int.network_access_control.authentication_priority_dot1x_webauth, null)
        authentication_priority_mab                     = try(int.network_access_control.authentication_priority_mab, null)
        authentication_priority_mab_dot1x               = try(int.network_access_control.authentication_priority_mab_dot1x, null)
        authentication_priority_mab_webauth             = try(int.network_access_control.authentication_priority_mab_webauth, null)
        authentication_priority_webauth                 = try(int.network_access_control.authentication_priority_webauth, null)
        authentication_event_fail_action_authorize_vlan = try(int.network_access_control.authentication_event_fail_action_authorize_vlan, null)
        authentication_event_fail_action_next_method    = try(int.network_access_control.authentication_event_fail_action_next_method, null)
...
resource "iosxe_interface_ethernet" "ethernet" {
  ...
  authentication_order_dot1x                      = each.value.authentication_order_dot1x
  authentication_order_dot1x_mab                  = each.value.authentication_order_dot1x_mab
  authentication_order_dot1x_webauth              = each.value.authentication_order_dot1x_webauth
  authentication_order_mab                        = each.value.authentication_order_mab
  authentication_order_mab_dot1x                  = each.value.authentication_order_mab_dot1x
  authentication_order_mab_webauth                = each.value.authentication_order_mab_webauth
  authentication_order_webauth                    = each.value.authentication_order_webauth
  authentication_priority_dot1x                   = each.value.authentication_priority_dot1x
  authentication_priority_dot1x_mab               = each.value.authentication_priority_dot1x_mab
  authentication_priority_dot1x_webauth           = each.value.authentication_priority_dot1x_webauth
  authentication_priority_mab                     = each.value.authentication_priority_mab
  authentication_priority_mab_dot1x               = each.value.authentication_priority_mab_dot1x
  authentication_priority_mab_webauth             = each.value.authentication_priority_mab_webauth
  authentication_priority_webauth                 = each.value.authentication_priority_webauth
  authentication_event_fail_action_authorize_vlan = each.value.authentication_event_fail_action_authorize_vlan
  authentication_event_fail_action_next_method    = each.value.authentication_event_fail_action_next_method
